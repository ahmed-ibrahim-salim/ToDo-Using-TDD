...
class ItemListDataProviderTests: XCTestCase {
    ...
    func test_NumberOfRows_Section1_ToDoCount(){
    ...
    func test_ConfigCellWithToDoItem_CallsConfigCellWithPassedToDoItem(){
        let mockTableView = MockTableView.mockTableView(withDataSource: sut)
    ...
    func test_SelectingACell_SendsNotification() {
        ...
        // if returns true, it fulfills the expectation
        expectation(forNotification: NSNotification.Name("ItemSelectedNotification"), object: nil){
